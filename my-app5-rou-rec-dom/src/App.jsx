...
import SettingComponent from './components/sections/DashboardCOmponents/SettingComponent.jsx'
import ProfileComponent from './components/sections/DashboardCOmponents/ProfileComponent.jsx'
const App = () => {
  return (
    <>
      <Router>
